...
void initializeDefaultScene( out STriangle triangles[12],  out SSphere spheres[2])
{
	...
	spheres[0].Radius =  2; // тут был(1.5)
...
vec3 Phong ( SCamera uCamera, SIntersection intersect, SLight currLight, float shadowing)
{
	...
	return intersect.LightCoeffs.x * intersect.Color + intersect.LightCoeffs.y * diffuse 
	* intersect.Color * shadowing  + intersect.LightCoeffs.z * specular * Unit;
}
